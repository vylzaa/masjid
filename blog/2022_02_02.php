...
<head>
    ...
    <title>Masjid Al-Ikhlas Dakota</title>
    <!-- MDB icon -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            <div class="container">
                <a class="navbar-brand" href="../index.php">
                    <img src="../img/logo.png" height="30" alt="Masjid Al-Ikhlas Dakota" loading="lazy" />
                </a>
                    ...
                    <section class="mb-10">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-lg-7">
                                ...
                                <span> Published <u>5.05.2024</u> by</span> <a href="undefined" class="text-dark" aria-controls="#picker-editor">Muhammad Irfani</a>
                            </div>
                        </div>
